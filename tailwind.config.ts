  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        icon: '0px 0px 0px 1px rgba(16, 24, 40, 0.18) inset, 0px -2px 0px 0px rgba(16, 24, 40, 0.05) inset, 0px 1px 2px 0px rgba(16, 24, 40, 0.05)',
        image: '0px 32px 64px -12px rgba(16, 24, 40, 0.14)',
      },
      aria: {
